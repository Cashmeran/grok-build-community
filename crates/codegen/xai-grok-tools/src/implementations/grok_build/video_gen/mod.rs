...
pub(crate) const TIER_RESTRICTED_UPSELL: &str = "Video generation is not available with your current API configuration. Check your API provider's capabilities or use a provider that supports video generation. Do not retry this tool.";
