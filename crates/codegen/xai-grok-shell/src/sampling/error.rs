...
/// Community Edition: generic message, no provider-specific upsell.
pub const RATE_LIMITED_USER_MESSAGE_OAUTH: &str =
    "You\u{2019}ve hit the API rate limit. Please wait and try again later.";

/// API key / team rate-limit copy.
/// Community Edition: generic message, no xAI docs links or brand references.
pub const RATE_LIMITED_USER_MESSAGE_API_KEY: &str = "You\u{2019}ve hit the API rate limit. Check your API provider\u{2019}s quota dashboard or try again later.";
...
/// Community Edition: generic message, no provider-specific upsell.
pub const FREE_USAGE_USER_MESSAGE: &str = "You\u{2019}ve reached your API quota limit. Please check your API provider\u{2019}s billing dashboard or try again later.";
...
mod tests {
    ...
    fn rate_limited_fallback_oauth_vs_api_key() {
        ...
        assert!(RATE_LIMITED_USER_MESSAGE_OAUTH.contains("API rate limit"));
        assert!(RATE_LIMITED_USER_MESSAGE_API_KEY.contains("API rate limit"));
        assert!(RATE_LIMITED_USER_MESSAGE_API_KEY.contains("quota dashboard"));
        assert!(!RATE_LIMITED_USER_MESSAGE_API_KEY.contains("x.ai"));
